...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~CuIQVADT#G188UznMjF5gAUelSRMaGL0MtkOSDoJlvB0jGeZM-jg",
  ...
  STATUS_READ_MSG: process.env.STATUS_READ_MSG || '✅️ Status Viewed by FAMOUS_TABISH',
  ...
  ANTIDELETE: process.env.ANTIDELETE !== undefined ? process.env.ANTIDELETE === 'true' : true,
  
  
  AUTO_REJECT_CALLS: process.env.AUTO_REJECT_CALLS !== undefined ? process.env.AUTO_REJECT_CALLS === 'true' : false, 
  NOT_ALLOW: process.env.NOT_ALLOW !== undefined ? process.env.NOT_ALLOW === 'true' : true,
  MODE: process.env.MODE || "private",
  OWNER_NAME: process.env.OWNER_NAME || "FAMOUS TABISH",
  AUTO_BLOCK: process.env.AUTO_BLOCK || "212,99,90",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923196335250",
